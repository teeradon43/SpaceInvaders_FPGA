...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="d4_16e" name="XLXI_1">
            <blockpin signalname="Bit_0" name="A0" />
            <blockpin signalname="Bit_1" name="A1" />
            <blockpin signalname="Bit_2" name="A2" />
            <blockpin signalname="Bit_3" name="A3" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <iomarker fontsize="28" x="896" y="384" name="Bit_0" orien="R180" />
        <branch name="Bit_1">
            <wire x2="928" y1="448" y2="448" x1="896" />
        </branch>
        <iomarker fontsize="28" x="896" y="448" name="Bit_1" orien="R180" />
        <branch name="Bit_2">
            <wire x2="928" y1="512" y2="512" x1="896" />
        </branch>
        <iomarker fontsize="28" x="896" y="512" name="Bit_2" orien="R180" />
        <branch name="Bit_3">
            <wire x2="928" y1="576" y2="576" x1="896" />
        </branch>
        <iomarker fontsize="28" x="896" y="576" name="Bit_3" orien="R180" />
        <branch name="D0">
        ...
        <iomarker fontsize="28" x="3152" y="224" name="G_7" orien="R0" />
        <branch name="F_7">
            <wire x2="3152" y1="528" y2="528" x1="3120" />
        </branch>
        <iomarker fontsize="28" x="3152" y="528" name="F_7" orien="R0" />
        <branch name="E_7">
            <wire x2="3152" y1="912" y2="912" x1="3120" />
        </branch>
        <iomarker fontsize="28" x="3152" y="912" name="E_7" orien="R0" />
        <branch name="D_7">
            <wire x2="3152" y1="1264" y2="1264" x1="3120" />
        </branch>
        <iomarker fontsize="28" x="3152" y="1264" name="D_7" orien="R0" />
        <branch name="C_7">
            <wire x2="3152" y1="1520" y2="1520" x1="3120" />
        </branch>
        <iomarker fontsize="28" x="3152" y="1520" name="C_7" orien="R0" />
        <branch name="A_7">
            <wire x2="3152" y1="2080" y2="2080" x1="3120" />
        </branch>
        <iomarker fontsize="28" x="3152" y="2080" name="A_7" orien="R0" />
        <branch name="XLXN_38">
        ...
        <iomarker fontsize="28" x="3152" y="1792" name="B_7" orien="R0" />
